...
public class AnalyticsEventServiceImplIT extends IntegrationTestBase {
    ...
    void testSaveEvent() {
        var givenAnalyticsEvent = faang.school.analytics.model.entity.AnalyticsEvent.builder()
                .receiverId(2L)
                .actorId(3L)
        ...
        var expected = faang.school.analytics.model.entity.AnalyticsEvent.builder()
                .id(4L)
                .receiverId(2L)
                .actorId(3L)
                .eventType(EventType.PROFILE_VIEW)
    ...
    void testGetAnalyticsEventsWithIntervalIsNull() {
        ...
        var element1 = AnalyticsEvent.builder()
                .id(2L)
                .receiverId(1L)
                .actorId(2L)
                .eventType(EventType.PROFILE_VIEW)
        ...
        var element2 = AnalyticsEvent.builder()
                .id(1L)
                .receiverId(1L)
                .actorId(3L)
                .eventType(EventType.PROFILE_VIEW)
